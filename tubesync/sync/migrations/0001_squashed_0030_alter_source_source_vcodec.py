    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        auto_now_add=True,
                        db_index=True,
                        help_text="Date and time the source was created",
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True,
                        db_index=True,
                        help_text="Date and time the source was last crawled",
                        null=True,
                        verbose_name="last crawl",
                    ),
                ),
                (
                    "source_type",
                ...
                (
                    ...
                    models.CharField(
                        db_index=True,
                        help_text="Source key, such as exact YouTube channel name or playlist ID",
                        max_length=100,
                        unique=True,
                        verbose_name="key",
                    ),
                ...
                (
                    ...
                    models.CharField(
                        db_index=True,
                        help_text="Friendly name for the source, used locally in TubeSync only",
                        max_length=100,
                        unique=True,
                        verbose_name="name",
                    ),
                ...
                (
                    ...
                    models.CharField(
                        db_index=True,
                        help_text="Directory name to save the media into",
                        max_length=100,
                        unique=True,
                ...
                (
                    ...
                    models.IntegerField(
                        ...
                        db_index=True,
                        default=86400,
                        help_text="Schedule of how often to index the source for new media",
                        verbose_name="index schedule",
                    ),
                ),
                (
                    "delete_old_media",
                    models.BooleanField(
                        default=False,
                        help_text='Delete old media after "days to keep" days?',
                        verbose_name="delete old media",
                    ),
                ),
                (
                    "days_to_keep",
                    models.PositiveSmallIntegerField(
                        default=14,
                        help_text='If "delete old media" is ticked, the number of days after which to automatically delete media',
                        verbose_name="days to keep",
                    ),
                ),
                (
                    "source_resolution",
                    models.CharField(
                        ...
                        db_index=True,
                        default="1080p",
                        help_text="Source resolution, desired video resolution to download",
                        max_length=8,
                ...
                (
                    "source_vcodec",
                    models.CharField(
                        choices=[("AVC1", "AVC1 (H.264)"), ("VP9", "VP9")],
                        db_index=True,
                        default="VP9",
                        help_text='Source video codec, desired video encoding format to download (ignored if "resolution" is audio only)',
                        max_length=8,
                        verbose_name="source video codec",
                    ),
                ),
                (
                    "source_acodec",
                    models.CharField(
                        choices=[("MP4A", "MP4A"), ("OPUS", "OPUS")],
                        db_index=True,
                        default="OPUS",
                        help_text="Source audio codec, desired audio encoding format to download",
                        max_length=8,
                        verbose_name="source audio codec",
                    ),
                ),
                (
                    "prefer_60fps",
                    models.BooleanField(
                        default=True,
                        help_text="Where possible, prefer 60fps media for this source",
                        verbose_name="prefer 60fps",
                    ),
                ),
                (
                    "prefer_hdr",
                    models.BooleanField(
                        default=False,
                        help_text="Where possible, prefer HDR media for this source",
                        verbose_name="prefer hdr",
                    ),
                ),
                (
                    "fallback",
                    models.CharField(
                        choices=[
                            ...
                            ("n", "Get next best resolution or codec instead"),
                            ("h", "Get next best resolution but at least HD"),
                        ],
                        db_index=True,
                        default="h",
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Source has failed to index media",
                        verbose_name="has failed",
                    ),
                ),
                (
                    "copy_thumbnails",
                ...
                (
                    "media_format",
                    models.CharField(
                        default="{yyyy_mm_dd}_{source}_{title}_{key}_{format}.{ext}",
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Write an NFO file in XML with the media info, these may be detected and used by some media servers",
                ...
                (
                    ...
                    models.IntegerField(
                        choices=[
                            ...
                            (94608000, "3 years (1095 days)"),
                            (157680000, "5 years (1825 days)"),
                            (315360000, "10 years (3650 days)"),
                        ],
                        default=0,
                        help_text="Do not download media older than this capped date",
                        verbose_name="download cap",
                    ),
                ),
                (
                    "download_media",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        db_index=True,
                        help_text="Hostname or IP address of the media server",
                        max_length=200,
                        verbose_name="host",
                    ),
                ),
                (
                    ...
                    models.PositiveIntegerField(
                        db_index=True,
                        help_text="Port number of the media server",
                        verbose_name="port",
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        auto_now_add=True,
                        db_index=True,
                        help_text="Date and time the media was created",
                        verbose_name="created",
                    ),
                ),
                (
                    ...
                    models.DateTimeField(
                        blank=True,
                        db_index=True,
                        help_text="Date and time the media was published on the source",
                        null=True,
                ...
                (
                    ...
                    models.CharField(
                        db_index=True,
                        help_text="Media key, such as exact YouTube video ID",
                        max_length=100,
                        verbose_name="key",
                    ),
                ),
                (
                    ...
                    models.ImageField(
                        ...
                        max_length=200,
                        null=True,
                        upload_to=sync.models.get_media_thumb_path,
                        verbose_name="thumb",
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        blank=True,
                        help_text="Width (X) of the thumbnail",
                        null=True,
                        verbose_name="thumb width",
                    ),
                ),
                (
                    "thumb_height",
                    models.PositiveSmallIntegerField(
                        blank=True,
                        help_text="Height (Y) of the thumbnail",
                        null=True,
                        verbose_name="thumb height",
                    ),
                ),
                (
                    "metadata",
                    models.TextField(
                        blank=True,
                        help_text="JSON encoded metadata for the media",
                        null=True,
                ...
                (
                    ...
                    models.BooleanField(
                        db_index=True,
                        default=False,
                        help_text="Media has a matching format and can be downloaded",
                ...
                (
                    ...
                    models.BooleanField(
                        db_index=True,
                        default=False,
                        help_text="Media will be skipped and not downloaded",
                        verbose_name="skip",
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        db_index=True,
                        default=False,
                        help_text="Media has been downloaded",
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True,
                        db_index=True,
                        help_text="Date and time the download completed",
                        null=True,
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        blank=True,
                        help_text="Height in pixels of the downloaded media",
                        null=True,
                        verbose_name="downloaded height",
                    ),
                ),
                (
                    "downloaded_width",
                    models.PositiveIntegerField(
                        blank=True,
                        help_text="Width in pixels of the downloaded media",
                        null=True,
                        verbose_name="downloaded width",
                    ),
                ),
                (
                    "downloaded_audio_codec",
                    models.CharField(
                        blank=True,
                        help_text="Audio codec of the downloaded media",
                        max_length=30,
                        null=True,
                        verbose_name="downloaded audio codec",
                    ),
                ),
                (
                    "downloaded_video_codec",
                    models.CharField(
                        blank=True,
                        help_text="Video codec of the downloaded media",
                        max_length=30,
                        null=True,
                        verbose_name="downloaded video codec",
                    ),
                ),
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Container format of the downloaded media",
                        max_length=30,
                        null=True,
                        verbose_name="downloaded container format",
                    ),
                ),
                (
                    "downloaded_fps",
                    models.PositiveSmallIntegerField(
                        blank=True,
                        help_text="FPS of the downloaded media",
                        null=True,
                        verbose_name="downloaded fps",
                    ),
                ),
                (
                    "downloaded_hdr",
                    models.BooleanField(
                        default=False,
                        help_text="Downloaded media has HDR",
                        verbose_name="downloaded hdr",
                    ),
                ),
                (
                    "downloaded_filesize",
                    models.PositiveBigIntegerField(
                        blank=True,
                        db_index=True,
                        help_text="Size of the downloaded media in bytes",
                        null=True,
                        verbose_name="downloaded filesize",
                    ),
                ),
                (
                    "source",
                    models.ForeignKey(
                        help_text="Source the media belongs to",
        ...
        migrations.AlterField(
            ...
            field=models.FileField(
                ...
                null=True,
                storage=django.core.files.storage.FileSystemStorage(
                    base_url="/media-data/", location=media_file_location()
                ),
                upload_to=sync.models.get_media_file_path,
                verbose_name="media file",
            ),
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(
                default=False,
                help_text="Download video subtitles",
                verbose_name="write subtitles",
            ),
        ),
        migrations.AddField(
            model_name="source",
            ...
            field=models.BooleanField(
                default=False,
                help_text="Delete media that is no longer on this playlist",
                verbose_name="delete removed media",
            ),
        ),
        migrations.AddField(
            model_name="source",
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(
                default=False,
                help_text="Delete files on disk when they are removed from TubeSync",
                verbose_name="delete files on disk",
            ),
        ),
        migrations.AddField(
            model_name="media",
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(
                ...
                default=True,
                help_text="When Filter Seconds is > 0, do we skip on minimum (video shorter than limit) or maximum (video greater than maximum) video duration",
        ...
        migrations.AlterField(
            ...
            name="source_vcodec",
            field=models.CharField(
                choices=[("AVC1", "AVC1 (H.264)"), ("VP9", "VP9"), ("AV1", "AV1")],
                db_index=True,
                default="VP9",
                help_text='Source video codec, desired video encoding format to download (ignored if "resolution" is audio only)',
                max_length=8,
